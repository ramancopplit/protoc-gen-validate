...
go get -d github.com/ramancopplit/protoc-gen-validate
```

> #### 💡 Yes, our go module path is `github.com/ramancopplit/protoc-gen-validate` **not** `bufbuild` this is intentional.
...
version: v1
deps:
  - buf.build/ramancopplit/protoc-gen-validate
```
